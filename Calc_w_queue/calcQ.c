 ...
 * calcQ.c
 *
 *  Created on: 4 июня 2020 г.
 *      Author: Ekaterina Tararsova
 *      Descriptions:Калькулятор с получением списка задач из файла для использования обратной польской нотации на использование очереди и стека.
